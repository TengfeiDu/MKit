 ...
 */
#if 0
#if HAVE_CONFIG_H_QREN
# include "config_qrencode.h"
#endif
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
static int margin = -1;
static int dpi = 72;
static __attribute__((unused)) int structured = 0;
static int rle = 0;
static int micro = 0;
...
static __attribute__((unused)) char *optstring = "ho:l:s:v:m:d:t:Skci8MV";

static __attribute__((unused)) void usage(int help, int longopt)
{
	fprintf(stderr,
"qrencode version %s\n"
...
static __attribute__((unused)) int color_set(unsigned int color[4], const char *value)
{
...
static __attribute__((unused)) unsigned char *readStdin(int *length)
{
...
static __attribute__((unused)) void qrencode(const unsigned char *intext, int length, const char *outfile)
{
	QRcode *qrcode;
...
static __attribute__((unused)) void qrencodeStructured(const unsigned char *intext, int length, const char *outfile)
{
