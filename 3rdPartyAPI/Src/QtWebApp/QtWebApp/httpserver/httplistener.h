...
MHttpRequestHandler *handler = new MHttpRequestHandler();
QSettings *set = new QSettings("QtWebApp.ini",QSettings::IniFormat,&a);
set->beginGroup("listener");
HttpListener *http = new HttpListener(set, handler, &a);
